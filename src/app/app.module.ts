...
@NgModule({
  ...
  declarations: [
    ...
    DashboardComponent,
    DashStatusComponent,
    DashGraphComponent, DashBarChartComponent, DashGaugeComponent, DashPiegridComponent, DashDonutComponent, DashboardAirportComponent, DashboardDetectionComponent, DashboardCrowdComponent, DashGraphInComponent
  ],
